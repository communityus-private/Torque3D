...
$Pref::Server::ConnectionError = "You do not have the correct version of AFXDemo or the related art needed to play on this server, please contact the server administrator.";
