<?php /* Smarty version 2.6.18, created on 2015-06-23 11:33:28
         compiled from vc2013_shared_x64.tpl */ ?>
<?php echo '<?xml'; ?>
...
<Project DefaultTargets="Build" ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    ...
    <OutDir Condition="'$(Configuration)|$(Platform)'=='Debug|x64'"><?php echo $this->_tpl_vars['projectOffset']; ?>
../../<?php echo $this->_tpl_vars['gameFolder']; ?>
/</OutDir>
    <IntDir Condition="'$(Configuration)|$(Platform)'=='Debug|x64'"><?php echo $this->_tpl_vars['projectOffset']; ?>
../Link/VC2013.$(Configuration).$(PlatformName)/$(ProjectName)/</IntDir>
    <LinkIncremental Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">true</LinkIncremental>
    <TargetName Condition="'$(Configuration)|$(Platform)'=='Debug|x64'"><?php echo $this->_tpl_vars['projOutName']; ?>
_DEBUG</TargetName>
    <OutDir Condition="'$(Configuration)|$(Platform)'=='Optimized Debug|x64'"><?php echo $this->_tpl_vars['projectOffset']; ?>
../../<?php echo $this->_tpl_vars['gameFolder']; ?>
/</OutDir>
    <IntDir Condition="'$(Configuration)|$(Platform)'=='Optimized Debug|x64'"><?php echo $this->_tpl_vars['projectOffset']; ?>
../Link/VC2013.$(Configuration).$(PlatformName)/$(ProjectName)/</IntDir>
    <LinkIncremental Condition="'$(Configuration)|$(Platform)'=='Optimized Debug|x64'">false</LinkIncremental>
    <TargetName Condition="'$(Configuration)|$(Platform)'=='Optimized Debug|x64'"><?php echo $this->_tpl_vars['projOutName']; ?>
_OPTIMIZEDDEBUG</TargetName>
    <OutDir Condition="'$(Configuration)|$(Platform)'=='Release|x64'"><?php echo $this->_tpl_vars['projectOffset']; ?>
../../<?php echo $this->_tpl_vars['gameFolder']; ?>
/</OutDir>
    <IntDir Condition="'$(Configuration)|$(Platform)'=='Release|x64'"><?php echo $this->_tpl_vars['projectOffset']; ?>
../Link/VC2013.$(Configuration).$(PlatformName)/$(ProjectName)/</IntDir>
    <LinkIncremental Condition="'$(Configuration)|$(Platform)'=='Release|x64'">false</LinkIncremental>
    <TargetName Condition="'$(Configuration)|$(Platform)'=='Release|x64'"><?php echo $this->_tpl_vars['projOutName']; ?>
</TargetName>
  </PropertyGroup>
...
;<?php endforeach; endif; unset($_from); ?>%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    foreach ($_from as $this->_tpl_vars['def']):
?><?php echo $this->_tpl_vars['def']; ?>
;<?php endforeach; endif; unset($_from); ?>WIN32;_WIN64;__AMD64__;__WIN64__;TORQUE_DEBUG;TORQUE_DEBUG_GUARD;D3D_DEBUG_INFO;TORQUE_NET_STATS;UNICODE;_CRT_SECURE_NO_DEPRECATE;_CRT_SECURE_NO_WARNINGS;%(PreprocessorDefinitions)</PreprocessorDefinitions>
...
../Link/VC2013.$(Configuration).$(PlatformName);%(AdditionalLibraryDirectories)</AdditionalLibraryDirectories>
...
;<?php endforeach; endif; unset($_from); ?>%(IgnoreSpecificDefaultLibraries)</IgnoreSpecificDefaultLibraries>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Release|x64'">
    ...
    foreach ($_from as $this->_tpl_vars['def']):
?><?php echo $this->_tpl_vars['def']; ?>
;<?php endforeach; endif; unset($_from); ?>_WIN64;__AMD64__;__WIN64__;TORQUE_SHARED;WIN32;UNICODE;_CRT_SECURE_NO_DEPRECATE;_CRT_SECURE_NO_WARNINGS;%(PreprocessorDefinitions)</PreprocessorDefinitions>
      <ExceptionHandling>Sync</ExceptionHandling>
      <BasicRuntimeChecks>Default</BasicRuntimeChecks>
      <StringPooling>true</StringPooling>
      <RuntimeLibrary><?php if ($this->_tpl_vars['projRuntimeRelease'] == 0): ?>MultiThreaded<?php else: ?>MultiThreadedDLL<?php endif; ?></RuntimeLibrary>
...
.exe</OutputFile>
      <SuppressStartupBanner>true</SuppressStartupBanner>
      <AdditionalLibraryDirectories>../../Link/VC2013.$(Configuration).$(PlatformName);%(AdditionalLibraryDirectories)</AdditionalLibraryDirectories>
      <IgnoreSpecificDefaultLibraries>LIBC;LIBCD;<?php $_from = $this->_tpl_vars['projLibsIgnore']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['def']):
?><?php echo $this->_tpl_vars['def']; ?>
;<?php endforeach; endif; unset($_from); ?>%(IgnoreSpecificDefaultLibraries)</IgnoreSpecificDefaultLibraries>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "vc2013_fileRecurse_x64.tpl", 'smarty_include_vars' => array('dirWalk' => $this->_tpl_vars['dirWalk'],'depth' => 1,'dirPath' => $this->_tpl_vars['projOutput']->base_dir)));
