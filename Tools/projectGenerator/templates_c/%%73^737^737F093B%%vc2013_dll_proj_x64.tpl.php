<?php /* Smarty version 2.6.18, created on 2015-06-23 11:57:35
         compiled from vc2013_dll_proj_x64.tpl */ ?>
<?php echo '<?xml'; ?>
...
;<?php endforeach; endif; unset($_from); ?>%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    foreach ($_from as $this->_tpl_vars['def']):
?><?php echo $this->_tpl_vars['def']; ?>
;<?php endforeach; endif; unset($_from); ?>_WIN64;__AMD64__;__WIN64__;TORQUE_DEBUG;TORQUE_DEBUG_GUARD;D3D_DEBUG_INFO;TORQUE_NET_STATS;UNICODE;_CRT_SECURE_NO_DEPRECATE;_CRT_SECURE_NO_WARNINGS;%(PreprocessorDefinitions)</PreprocessorDefinitions>
...
;<?php endforeach; endif; unset($_from); ?>%(IgnoreSpecificDefaultLibraries)</IgnoreSpecificDefaultLibraries>
      <ModuleDefinitionFile><?php echo $this->_tpl_vars['projModuleDefinitionFile']; ?>
...
;<?php endforeach; endif; unset($_from); ?>%(AdditionalDependencies)</AdditionalDependencies>
      <OutputFile>$(OutDir)<?php echo $this->_tpl_vars['projOutName']; ?>
_OPTIMIZEDDEBUG.dll</OutputFile>
      <SuppressStartupBanner>true</SuppressStartupBanner>
      <AdditionalLibraryDirectories><?php $_from = $this->_tpl_vars['projLibDirs']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['def']):
?><?php echo $this->_tpl_vars['def']; ?>
...
;<?php endforeach; endif; unset($_from); ?>%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    foreach ($_from as $this->_tpl_vars['def']):
?><?php echo $this->_tpl_vars['def']; ?>
;<?php endforeach; endif; unset($_from); ?>_WIN64;__AMD64__;__WIN64__;UNICODE;_CRT_SECURE_NO_DEPRECATE;_CRT_SECURE_NO_WARNINGS;%(PreprocessorDefinitions)</PreprocessorDefinitions>
      <ExceptionHandling>Sync</ExceptionHandling>
      <BasicRuntimeChecks>Default</BasicRuntimeChecks>
      <StringPooling>true</StringPooling>
