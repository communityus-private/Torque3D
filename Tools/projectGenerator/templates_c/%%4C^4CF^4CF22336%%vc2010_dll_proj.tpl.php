<?php /* Smarty version 2.6.18, created on 2015-10-27 09:21:08
         compiled from vc2010_dll_proj.tpl */ ?>
<?php echo '<?xml'; ?>
...
_OPTIMIZEDDEBUG DLL</TargetName>
...
;<?php endforeach; endif; unset($_from); ?>$(DXSDK_DIR)/Include;%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
...
../Link/VC2010.$(Configuration).$(PlatformName);$(DXSDK_DIR)/Lib/x86;%(AdditionalLibraryDirectories)</AdditionalLibraryDirectories>
